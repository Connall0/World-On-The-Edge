...
NDiplomacy = {
	...
	TENSION_TIME_SCALE_START_DATE = "1963.1.1.12",	-- Starting at this date, the tension values will be scaled down (will be equal to 1 before that)
...
NCountry = {
	...
	POLITICAL_POWER_CAP = 800.0,					-- Max amount of political power country should have
...
NPolitics = {
	...
	BASE_POLITICAL_POWER_INCREASE = 1.25,	-- Weekly increase of PP.
	...
	INSTANT_WIN_POPULARITY_WIN = 100, -- New party popularity
},
